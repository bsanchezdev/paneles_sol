...
<html>
 ...
 <h3 class="panel-title"><i class="fa fa-dashboard">&nbsp;</i>CARGA SITREL FINANCOOP</h3>
        ...
        <div class="col-lg-12">
        <div class="row">
                <div class="col-lg-12" style="text-align: center;"><img src="<?= base_url("/imagenes/financoop/logo-financoop.jpg"); ?>" width="322" height="81" alt="logo-financoop"/></div>
        </div>    
        <ul class="list-group">
            ...
            $("#paso1").on("click",function(e)
        {
          ...
          //  $("#carbdd").toggleClass("hidden");
            $.post( "<?= base_url("c_p/financoop_interfaz_v2/indexrobot");?>", function( data ) {
